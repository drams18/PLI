...
with_node \
  ...
  --target "/Users/dramsss/Documents/ETNA/PLI/flawa/ios/Pods/Target Support Files/Pods-flawa/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-barcode-scanner" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake"
